...
let provider = new ethers.providers.JsonRpcProvider(process.env.JSON_RPC_PROVIDER);

provider.getNetwork().then(async (network) => {
	var tokenId = -1; // TODO fill this in
	var leverIds = []; // TODO fill this in
	var newValues = []; // TODO fill this in
